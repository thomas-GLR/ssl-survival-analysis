...
from scania.utils import (
    ...
    train_model_cotraining_ensemble_ordinal,
)
...
def reproduce_result(
    ...
    gpu_aware_versions = {
        ...
        ModelVersion.CO_TRAINING_ENSEMBLE_ORDINAL,
    }
...
def _get_train_model_method(model_version: ModelVersion) -> Callable:
    match model_version:
        ...
        case ModelVersion.CO_TRAINING_ENSEMBLE_ORDINAL:
            return train_model_cotraining_ensemble_ordinal
