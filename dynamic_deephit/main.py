...
for itr in range(iteration):
    ...
    if (itr+1)%1000 == 0:        
        risk_all = f_get_risk_predictions(model, va_data, va_data_mi, pred_time, eval_time)
...
ckpt.restore(file_path + '/model').expect_partial()

risk_all = f_get_risk_predictions(model, te_data, te_data_mi, pred_time, eval_time)
