...
def get_necessary_dataset_keys(model_version: ModelVersion, necessary_keys_module: ModuleType) -> list[str]:
    match model_version:
        ...
        case ModelVersion.CO_TRAINING_ENSEMBLE_ORDINAL:
            return necessary_keys_module.NECESSARY_DATASET_CO_TRAINING_ENSEMBLE_ORDINAL_KEYS
...
def get_necessary_model_keys(model_version: ModelVersion, necessary_keys_module: ModuleType) -> list[str]:
    match model_version:
        ...
        case ModelVersion.CO_TRAINING_ENSEMBLE_ORDINAL:
            return necessary_keys_module.NECESSARY_CO_TRAINING_ENSEMBLE_ORDINAL_KEYS
        case ModelVersion.TRANSFORMER_FEATURES:
...
def get_necessary_training_keys(model_version: ModelVersion, necessary_keys_module: ModuleType) -> list[str]:
    match model_version:
        ...
        case ModelVersion.CO_TRAINING_ENSEMBLE_ORDINAL:
            return necessary_keys_module.NECESSARY_TRAINING_CO_TRAINING_ENSEMBLE_ORDINAL_KEYS
        case ModelVersion.TRANSFORMER_FEATURES:
