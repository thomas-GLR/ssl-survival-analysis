...
from models.CoTrainingEnsemble_v3 import CoTrainingEnsemble_v3 as CoTrainingEnsembleV3
...
def train_model_v3(
    ...
    """Confidence-based co-training ensemble (``CoTrainingEnsemble_v3``).

    Mirrors :func:`train_model_v2` but drives the v3 ensemble: each model *owns* the remaining
    censored unit it is most confident about (smallest ``crepes`` interval width, normalized per
    ...
    cotraining_ensemble = CoTrainingEnsembleV3(
        models=models,
        verbose=2,
        confidence=confidence,
    ...
    print(f"Training Coprog v3 model...")
